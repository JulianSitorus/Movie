...
@section('content')
    <div class="movie-info border-b border-gray-800">
        <div class="container mx-auto py-16 flex flex-col md:flex-row" style="padding-left:97px; padding-right:97px">
            <img src="{{$movie['poster_path']}}" alt="" class="w-64 md:w-96" style="width:20rem">
            <div class="md:ml-24">

                <h2 class="text-4xl font-semibold">{{$movie['title']}} ({{ \Carbon\carbon::parse($movie['release_date'])->format('Y')}})</h2>
                <h6 class="ml-0.5">{{$movie['tagline']}}</h6>
                                ...
                                <div class="bg-gray-900 rounded">
                                    ...
                                    <div class="modal-body px-8 py-8">
                                        <div class="responsive-container overflow-hidden relative" style="padding-top: 56.25%;">
                                            ...
                                            left-0 w-full h-full" src="https://www.youtube.com/embed/{{ $movie['videos']['results'][0]['key']}}"
    ...
    <div class="movie-cast border-b border-gray-800 pb-16" style="padding-left:97px; padding-right:97px">
