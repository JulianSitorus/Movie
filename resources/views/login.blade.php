    ...
    <style>
        body {
            background: linear-gradient(rgba(255, 255, 255, 0.5), rgba(255, 255, 255, 0.5)), 
                        url('{{ asset('img/movie_wallpaper.png') }}');
...
<body>
    ...
    <section class="">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="#" class="flex items-center mb-6 text-3xl font-bold dark:text-gray-900">
                <i class='bx bxs-camera-movie' style="color:orange"></i>
                &nbsp;MovieApp    
            </a>
                ...
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    @csrf
                        <div>
                            ...
                            <input type="email" name="email" id="email" valuen="{{ Session::get('email') }}" placeholder="name@company.com" required
